        ...
        <section id="contact" className="container-prose">
          <div className="glass rounded-2xl p-6">
            ...
            <div className="mt-6 text-center">
              <a href="mailto:prabhpreet429@gmail.com" className="inline-flex items-center rounded-xl bg-[var(--color-secondary)] px-6 py-3 text-sm font-semibold text-black hover:opacity-90">Email me</a>
            </div>
          </div>
        </section>
      </main>
